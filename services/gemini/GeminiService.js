...
class GeminiService {
  ...
  async getContentFromGPT (context, language, trends) {
    ...
    try {
      ...
      Content: ${context}
      1. Provide a summary strictly in ${language} language of the key points from the article above. The summary should be 60 - 80 words in length. Focus on capturing the main ideas and key details in a clear and concise way. Summarize the essence of the article accurately regardless of its length.
