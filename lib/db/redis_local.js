...
class redisLib extends redis_lib {
  ...
  init () {
    return new Promise((resolve, reject) => {
     ...
     console.log('redisLib.init, initializing redis connection ', { port: __config.redis_local.port, host: __config.redis_local.host, uri: __config.redis_local.uri })
      let redisClient = redis.createClient(__config.redis_local)// (__config.redis_local.port, __config.redis_local.host, {});
      redisClient.on('error',  (err) => {
        console.log('redisLib.init, error in redis connection ', { port: __config.redis_local.port, host: __config.redis_local.host, err: err })
        vm.connection = null
