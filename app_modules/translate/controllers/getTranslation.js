...
const translateServices = require('../../../services/translate/TranslateService')
...
const getTranslation = async (req, res) => {
  try {
    const result = await translateServices.predictionTranslation(req.body.predictionObj, req.body.lang)
...
router.post('/getTranslation', cache.route(600), validation, getTranslation)
