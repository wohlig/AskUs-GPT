...
const algoliaSearchQuery = async (req, res) => {
  try {
    const result = await AlgoliaService.searchQueryAlgolia(req.body.searchData, req.body.page, req.body.language, req.body.userId, req.body.blockedSources, req.body.categories, req.body.country)
