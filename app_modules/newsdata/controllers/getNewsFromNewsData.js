...
const getNewsData = async (req, res) => {
  try {
    const result = await NewsDataService.getNewsFromNewsData(req.body.categoryName, req.body.from, req.body.to)
...
router.post('/getNewsData', cache.route(10), validation, getNewsData)
