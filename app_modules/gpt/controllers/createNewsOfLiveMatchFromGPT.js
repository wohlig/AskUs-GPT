...
const createNewsOfLiveMatchFromGPT = async (req, res) => {
  console.log('req.body', req.body)
  try {
    const [fullContent, result] = await GptService.createNewsOfLiveMatchFromGPT(req.body)
    ...
    console.log('createNewsOfLiveMatchFromGPT Error', err)
    return res.sendJson({
...
router.post('/createNewsOfLiveMatchFromGPT', validation, createNewsOfLiveMatchFromGPT)
